...
TRANSFORM_DICT = {
    ...
    "album":
        T.Compose([
            ...
            lambda x: A.ImageCompression(quality_lower=1, quality_upper=50, p=0.20)(image=np.array(x))["image"],
            T.ToTensor(),
            T.RandomApply([color_shift], p=0.25),
            T.RandomApply([T.ColorJitter(brightness=0.5, contrast=0.3, saturation=0.3, hue=0.3)], p=0.5),
    ...
    "trdg":
        T.Compose([
            ...
            lambda x: A.ImageCompression(quality_lower=1, quality_upper=100, p=0.20)(image=np.array(x))["image"],
            T.ToPILImage(),
        ]),
    "trdgcolor":
        T.Compose([
